...
_PEERSERVICE = _descriptor.ServiceDescriptor(
  name='PeerService',
  full_name='candig.schemas.candig.PeerService',
  file=DESCRIPTOR,
  index=0,
  options=None,
  ...
  _descriptor.MethodDescriptor(
    name='ListPeers',
    full_name='candig.schemas.candig.PeerService.ListPeers',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='AnnouncePeer',
    full_name='candig.schemas.candig.PeerService.AnnouncePeer',
    index=1,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='Info',
    full_name='candig.schemas.candig.PeerService.Info',
    index=2,
    containing_service=None,
