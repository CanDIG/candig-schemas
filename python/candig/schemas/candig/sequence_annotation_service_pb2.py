...
_SEQUENCEANNOTATIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='candig.schemas.candig.SequenceAnnotationService',
  file=DESCRIPTOR,
  index=0,
  options=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='candig.schemas.candig.SequenceAnnotationService.SearchFeatureSets',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='GetFeatureSet',
    full_name='candig.schemas.candig.SequenceAnnotationService.GetFeatureSet',
    index=1,
    containing_service=None,
    input_type=_GETFEATURESETREQUEST,
    output_type=candig_dot_schemas_dot_candig_dot_sequence__annotations__pb2._FEATURESET,
  ...
  _descriptor.MethodDescriptor(
    name='SearchFeatures',
    full_name='candig.schemas.candig.SequenceAnnotationService.SearchFeatures',
    index=2,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='GetFeature',
    full_name='candig.schemas.candig.SequenceAnnotationService.GetFeature',
    index=3,
    containing_service=None,
    input_type=_GETFEATUREREQUEST,
    output_type=candig_dot_schemas_dot_candig_dot_sequence__annotations__pb2._FEATURE,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='candig.schemas.candig.SequenceAnnotationService.SearchContinuousSets',
    index=4,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='candig.schemas.candig.SequenceAnnotationService.GetContinuousSet',
    index=5,
    containing_service=None,
    input_type=_GETCONTINUOUSSETREQUEST,
    output_type=candig_dot_schemas_dot_candig_dot_sequence__annotations__pb2._CONTINUOUSSET,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='candig.schemas.candig.SequenceAnnotationService.SearchContinuous',
    index=6,
    containing_service=None,
