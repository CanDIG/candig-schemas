...
# source: ga4gh/schemas/google/api/http.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='ga4gh/schemas/google/api/http.proto',
...
_HTTP = _descriptor.Descriptor(
  name='Http',
  full_name='ga4gh.schemas.google.api.Http',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='rules', full_name='ga4gh.schemas.google.api.Http.rules', index=0,
...
_HTTPRULE = _descriptor.Descriptor(
  name='HttpRule',
  full_name='ga4gh.schemas.google.api.HttpRule',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='selector', full_name='ga4gh.schemas.google.api.HttpRule.selector', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get', full_name='ga4gh.schemas.google.api.HttpRule.get', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='put', full_name='ga4gh.schemas.google.api.HttpRule.put', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='post', full_name='ga4gh.schemas.google.api.HttpRule.post', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='delete', full_name='ga4gh.schemas.google.api.HttpRule.delete', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='patch', full_name='ga4gh.schemas.google.api.HttpRule.patch', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='custom', full_name='ga4gh.schemas.google.api.HttpRule.custom', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='body', full_name='ga4gh.schemas.google.api.HttpRule.body', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='additional_bindings', full_name='ga4gh.schemas.google.api.HttpRule.additional_bindings', index=8,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='pattern', full_name='ga4gh.schemas.google.api.HttpRule.pattern',
...
_CUSTOMHTTPPATTERN = _descriptor.Descriptor(
  ...
  full_name='ga4gh.schemas.google.api.CustomHttpPattern',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='kind', full_name='ga4gh.schemas.google.api.CustomHttpPattern.kind', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='path', full_name='ga4gh.schemas.google.api.CustomHttpPattern.path', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
Http = _reflection.GeneratedProtocolMessageType('Http', (_message.Message,), dict(
  DESCRIPTOR = _HTTP,
  __module__ = 'ga4gh.schemas.google.api.http_pb2'
  # @@protoc_insertion_point(class_scope:ga4gh.schemas.google.api.Http)
  ))
...
HttpRule = _reflection.GeneratedProtocolMessageType('HttpRule', (_message.Message,), dict(
  ...
  __module__ = 'ga4gh.schemas.google.api.http_pb2'
  # @@protoc_insertion_point(class_scope:ga4gh.schemas.google.api.HttpRule)
  ))
...
CustomHttpPattern = _reflection.GeneratedProtocolMessageType('CustomHttpPattern', (_message.Message,), dict(
  ...
  __module__ = 'ga4gh.schemas.google.api.http_pb2'
  # @@protoc_insertion_point(class_scope:ga4gh.schemas.google.api.CustomHttpPattern)
  ))
