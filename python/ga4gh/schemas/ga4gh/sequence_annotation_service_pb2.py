...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='ga4gh',
  syntax='proto3',
  serialized_pb=_b('\n5ga4gh/schemas/ga4gh/sequence_annotation_service.proto\x12\x05ga4gh\x1a.ga4gh/schemas/ga4gh/sequence_annotations.proto\x1a*ga4gh/schemas/google/api/annotations.proto\"U\n\x18SearchFeatureSetsRequest\x12\x12\n\ndataset_id\x18\x01 \x01(\t\x12\x11\n\tpage_size\x18\x02 \x01(\x05\x12\x12\n\npage_token\x18\x03 \x01(\t\"]\n\x19SearchFeatureSetsResponse\x12\'\n\x0c\x66\x65\x61ture_sets\x18\x01 \x03(\x0b\x32\x11.ga4gh.FeatureSet\x12\x17\n\x0fnext_page_token\x18\x02 \x01(\t\".\n\x14GetFeatureSetRequest\x12\x16\n\x0e\x66\x65\x61ture_set_id\x18\x01 \x01(\t\"\xd7\x01\n\x15SearchFeaturesRequest\x12\x16\n\x0e\x66\x65\x61ture_set_id\x18\x01 \x01(\t\x12\x0c\n\x04name\x18\x02 \x01(\t\x12\x13\n\x0bgene_symbol\x18\x03 \x01(\t\x12\x11\n\tparent_id\x18\x04 \x01(\t\x12\x16\n\x0ereference_name\x18\x05 \x01(\t\x12\r\n\x05start\x18\x06 \x01(\x03\x12\x0b\n\x03\x65nd\x18\x07 \x01(\x03\x12\x15\n\rfeature_types\x18\x08 \x03(\t\x12\x11\n\tpage_size\x18\t \x01(\x05\x12\x12\n\npage_token\x18\n \x01(\t\"S\n\x16SearchFeaturesResponse\x12 \n\x08\x66\x65\x61tures\x18\x01 \x03(\x0b\x32\x0e.ga4gh.Feature\x12\x17\n\x0fnext_page_token\x18\x02 \x01(\t\"\'\n\x11GetFeatureRequest\x12\x12\n\nfeature_id\x18\x01 \x01(\t\"X\n\x1bSearchContinuousSetsRequest\x12\x12\n\ndataset_id\x18\x01 \x01(\t\x12\x11\n\tpage_size\x18\x02 \x01(\x05\x12\x12\n\npage_token\x18\x03 \x01(\t\"f\n\x1cSearchContinuousSetsResponse\x12-\n\x0f\x63ontinuous_sets\x18\x01 \x03(\x0b\x32\x14.ga4gh.ContinuousSet\x12\x17\n\x0fnext_page_token\x18\x02 \x01(\t\"4\n\x17GetContinuousSetRequest\x12\x19\n\x11\x63ontinuous_set_id\x18\x01 \x01(\t\"\x8f\x01\n\x17SearchContinuousRequest\x12\x19\n\x11\x63ontinuous_set_id\x18\x01 \x01(\t\x12\x16\n\x0ereference_name\x18\x02 \x01(\t\x12\r\n\x05start\x18\x03 \x01(\x03\x12\x0b\n\x03\x65nd\x18\x04 \x01(\x03\x12\x11\n\tpage_size\x18\x05 \x01(\x05\x12\x12\n\npage_token\x18\x06 \x01(\t\"Z\n\x18SearchContinuousResponse\x12%\n\ncontinuous\x18\x01 \x03(\x0b\x32\x11.ga4gh.Continuous\x12\x17\n\x0fnext_page_token\x18\x02 \x01(\t2\xf3\x06\n\x19SequenceAnnotationService\x12\x80\x01\n\x11SearchFeatureSets\x12\x1f.ga4gh.SearchFeatureSetsRequest\x1a .ga4gh.SearchFeatureSetsResponse\"(\x82\xd3\xe4\x93\x02\"\"\x1d/v0.6.0a10/featuresets/search:\x01*\x12p\n\rGetFeatureSet\x12\x1b.ga4gh.GetFeatureSetRequest\x1a\x11.ga4gh.FeatureSet\"/\x82\xd3\xe4\x93\x02)\x12\'/v0.6.0a10/featuresets/{feature_set_id}\x12t\n\x0eSearchFeatures\x12\x1c.ga4gh.SearchFeaturesRequest\x1a\x1d.ga4gh.SearchFeaturesResponse\"%\x82\xd3\xe4\x93\x02\x1f\"\x1a/v0.6.0a10/features/search:\x01*\x12`\n\nGetFeature\x12\x18.ga4gh.GetFeatureRequest\x1a\x0e.ga4gh.Feature\"(\x82\xd3\xe4\x93\x02\"\x12 /v0.6.0a10/features/{feature_id}\x12\x8b\x01\n\x14SearchContinuousSets\x12\".ga4gh.SearchContinuousSetsRequest\x1a#.ga4gh.SearchContinuousSetsResponse\"*\x82\xd3\xe4\x93\x02$\"\x1f/v0.6.0a8/continuoussets/search:\x01*\x12~\n\x10GetContinuousSet\x12\x1e.ga4gh.GetContinuousSetRequest\x1a\x14.ga4gh.ContinuousSet\"4\x82\xd3\xe4\x93\x02.\x12,/v0.6.0a8/continuoussets/{continuous_set_id}\x12{\n\x10SearchContinuous\x12\x1e.ga4gh.SearchContinuousRequest\x1a\x1f.ga4gh.SearchContinuousResponse\"&\x82\xd3\xe4\x93\x02 \"\x1b/v0.6.0a8/continuous/search:\x01*b\x06proto3')
  ,
...
_SEARCHCONTINUOUSSETSREQUEST = _descriptor.Descriptor(
  ...
  full_name='ga4gh.SearchContinuousSetsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dataset_id', full_name='ga4gh.SearchContinuousSetsRequest.dataset_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='page_size', full_name='ga4gh.SearchContinuousSetsRequest.page_size', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='page_token', full_name='ga4gh.SearchContinuousSetsRequest.page_token', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SEARCHCONTINUOUSSETSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='ga4gh.SearchContinuousSetsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='continuous_sets', full_name='ga4gh.SearchContinuousSetsResponse.continuous_sets', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='next_page_token', full_name='ga4gh.SearchContinuousSetsResponse.next_page_token', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETCONTINUOUSSETREQUEST = _descriptor.Descriptor(
  ...
  full_name='ga4gh.GetContinuousSetRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='continuous_set_id', full_name='ga4gh.GetContinuousSetRequest.continuous_set_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SEARCHCONTINUOUSREQUEST = _descriptor.Descriptor(
  ...
  full_name='ga4gh.SearchContinuousRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='continuous_set_id', full_name='ga4gh.SearchContinuousRequest.continuous_set_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='reference_name', full_name='ga4gh.SearchContinuousRequest.reference_name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='start', full_name='ga4gh.SearchContinuousRequest.start', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='end', full_name='ga4gh.SearchContinuousRequest.end', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='page_size', full_name='ga4gh.SearchContinuousRequest.page_size', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='page_token', full_name='ga4gh.SearchContinuousRequest.page_token', index=5,
...
_SEARCHCONTINUOUSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='ga4gh.SearchContinuousResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='continuous', full_name='ga4gh.SearchContinuousResponse.continuous', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='next_page_token', full_name='ga4gh.SearchContinuousResponse.next_page_token', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
SearchContinuousSetsRequest = _reflection.GeneratedProtocolMessageType('SearchContinuousSetsRequest', (_message.Message,), dict(
  ...
  __module__ = 'ga4gh.schemas.ga4gh.sequence_annotation_service_pb2'
  # @@protoc_insertion_point(class_scope:ga4gh.SearchContinuousSetsRequest)
  ))
...
SearchContinuousSetsResponse = _reflection.GeneratedProtocolMessageType('SearchContinuousSetsResponse', (_message.Message,), dict(
  ...
  __module__ = 'ga4gh.schemas.ga4gh.sequence_annotation_service_pb2'
  # @@protoc_insertion_point(class_scope:ga4gh.SearchContinuousSetsResponse)
  ))
...
GetContinuousSetRequest = _reflection.GeneratedProtocolMessageType('GetContinuousSetRequest', (_message.Message,), dict(
  ...
  __module__ = 'ga4gh.schemas.ga4gh.sequence_annotation_service_pb2'
  # @@protoc_insertion_point(class_scope:ga4gh.GetContinuousSetRequest)
  ))
...
SearchContinuousRequest = _reflection.GeneratedProtocolMessageType('SearchContinuousRequest', (_message.Message,), dict(
  ...
  __module__ = 'ga4gh.schemas.ga4gh.sequence_annotation_service_pb2'
  # @@protoc_insertion_point(class_scope:ga4gh.SearchContinuousRequest)
  ))
...
SearchContinuousResponse = _reflection.GeneratedProtocolMessageType('SearchContinuousResponse', (_message.Message,), dict(
  ...
  __module__ = 'ga4gh.schemas.ga4gh.sequence_annotation_service_pb2'
  # @@protoc_insertion_point(class_scope:ga4gh.SearchContinuousResponse)
  ))
_sym_db.RegisterMessage(SearchContinuousResponse)



_SEQUENCEANNOTATIONSERVICE = _descriptor.ServiceDescriptor(
  name='SequenceAnnotationService',
  full_name='ga4gh.SequenceAnnotationService',
  file=DESCRIPTOR,
  index=0,
  options=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='ga4gh.SequenceAnnotationService.SearchFeatureSets',
    index=0,
    containing_service=None,
    input_type=_SEARCHFEATURESETSREQUEST,
    output_type=_SEARCHFEATURESETSRESPONSE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\"\"\035/v0.6.0a10/featuresets/search:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='GetFeatureSet',
    full_name='ga4gh.SequenceAnnotationService.GetFeatureSet',
    index=1,
    containing_service=None,
    input_type=_GETFEATURESETREQUEST,
    output_type=ga4gh_dot_schemas_dot_ga4gh_dot_sequence__annotations__pb2._FEATURESET,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002)\022\'/v0.6.0a10/featuresets/{feature_set_id}')),
  ),
  _descriptor.MethodDescriptor(
    name='SearchFeatures',
    full_name='ga4gh.SequenceAnnotationService.SearchFeatures',
    index=2,
    containing_service=None,
    input_type=_SEARCHFEATURESREQUEST,
    output_type=_SEARCHFEATURESRESPONSE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\037\"\032/v0.6.0a10/features/search:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='GetFeature',
    full_name='ga4gh.SequenceAnnotationService.GetFeature',
    index=3,
    containing_service=None,
    input_type=_GETFEATUREREQUEST,
    output_type=ga4gh_dot_schemas_dot_ga4gh_dot_sequence__annotations__pb2._FEATURE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\"\022 /v0.6.0a10/features/{feature_id}')),
  ),
  _descriptor.MethodDescriptor(
    name='SearchContinuousSets',
    full_name='ga4gh.SequenceAnnotationService.SearchContinuousSets',
    index=4,
    containing_service=None,
    input_type=_SEARCHCONTINUOUSSETSREQUEST,
    output_type=_SEARCHCONTINUOUSSETSRESPONSE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002$\"\037/v0.6.0a8/continuoussets/search:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='GetContinuousSet',
    full_name='ga4gh.SequenceAnnotationService.GetContinuousSet',
    index=5,
    containing_service=None,
    input_type=_GETCONTINUOUSSETREQUEST,
    output_type=ga4gh_dot_schemas_dot_ga4gh_dot_sequence__annotations__pb2._CONTINUOUSSET,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002.\022,/v0.6.0a8/continuoussets/{continuous_set_id}')),
  ),
  _descriptor.MethodDescriptor(
    name='SearchContinuous',
    full_name='ga4gh.SequenceAnnotationService.SearchContinuous',
    index=6,
    containing_service=None,
    input_type=_SEARCHCONTINUOUSREQUEST,
    output_type=_SEARCHCONTINUOUSRESPONSE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002 \"\033/v0.6.0a8/continuous/search:\001*')),
  ),
])
_sym_db.RegisterServiceDescriptor(_SEQUENCEANNOTATIONSERVICE)

DESCRIPTOR.services_by_name['SequenceAnnotationService'] = _SEQUENCEANNOTATIONSERVICE
