...
# source: ga4gh/schemas/ga4gh/references.proto
...
_REFERENCE = _descriptor.Descriptor(
  name='Reference',
  full_name='ga4gh.schemas.ga4gh.Reference',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='ga4gh.schemas.ga4gh.Reference.id', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='length', full_name='ga4gh.schemas.ga4gh.Reference.length', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='md5checksum', full_name='ga4gh.schemas.ga4gh.Reference.md5checksum', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='name', full_name='ga4gh.schemas.ga4gh.Reference.name', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='source_uri', full_name='ga4gh.schemas.ga4gh.Reference.source_uri', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='source_accessions', full_name='ga4gh.schemas.ga4gh.Reference.source_accessions', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_derived', full_name='ga4gh.schemas.ga4gh.Reference.is_derived', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='source_divergence', full_name='ga4gh.schemas.ga4gh.Reference.source_divergence', index=7,
...
_REFERENCESET = _descriptor.Descriptor(
  name='ReferenceSet',
  full_name='ga4gh.schemas.ga4gh.ReferenceSet',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='ga4gh.schemas.ga4gh.ReferenceSet.id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='name', full_name='ga4gh.schemas.ga4gh.ReferenceSet.name', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='md5checksum', full_name='ga4gh.schemas.ga4gh.ReferenceSet.md5checksum', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='description', full_name='ga4gh.schemas.ga4gh.ReferenceSet.description', index=4,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='assembly_id', full_name='ga4gh.schemas.ga4gh.ReferenceSet.assembly_id', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='source_uri', full_name='ga4gh.schemas.ga4gh.ReferenceSet.source_uri', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='source_accessions', full_name='ga4gh.schemas.ga4gh.ReferenceSet.source_accessions', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_derived', full_name='ga4gh.schemas.ga4gh.ReferenceSet.is_derived', index=8,
...
Reference = _reflection.GeneratedProtocolMessageType('Reference', (_message.Message,), dict(
  ...
  __module__ = 'ga4gh.schemas.ga4gh.references_pb2'
  # @@protoc_insertion_point(class_scope:ga4gh.schemas.ga4gh.Reference)
  ))
...
ReferenceSet = _reflection.GeneratedProtocolMessageType('ReferenceSet', (_message.Message,), dict(
  ...
  __module__ = 'ga4gh.schemas.ga4gh.references_pb2'
  # @@protoc_insertion_point(class_scope:ga4gh.schemas.ga4gh.ReferenceSet)
  ))
