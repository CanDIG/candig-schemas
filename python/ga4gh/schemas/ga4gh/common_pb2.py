...
_EXPERIMENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dataset_id', full_name='ga4gh.Experiment.dataset_id', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='biosample_id', full_name='ga4gh.Experiment.biosample_id', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dna_library_construction_method', full_name='ga4gh.Experiment.dna_library_construction_method', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='wgs_sequencing_completion_date', full_name='ga4gh.Experiment.wgs_sequencing_completion_date', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='rna_library_construction_method', full_name='ga4gh.Experiment.rna_library_construction_method', index=20,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='rna_sequencing_completion_date', full_name='ga4gh.Experiment.rna_sequencing_completion_date', index=21,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='panel_completion_date', full_name='ga4gh.Experiment.panel_completion_date', index=22,
...
_ANALYSIS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dataset_id', full_name='ga4gh.Analysis.dataset_id', index=8,
      number=10, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='experiment_id', full_name='ga4gh.Analysis.experiment_id', index=9,
      number=11, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='other_analysis_descriptor', full_name='ga4gh.Analysis.other_analysis_descriptor', index=10,
      number=12, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='other_analysis_completition_date', full_name='ga4gh.Analysis.other_analysis_completition_date', index=11,
      number=13, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
