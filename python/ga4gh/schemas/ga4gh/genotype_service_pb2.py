...
_GENOTYPE = _descriptor.EnumDescriptor(
  name='Genotype',
  full_name='ga4gh.schemas.ga4gh.Genotype',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_GENOTYPEMATRIX = _descriptor.Descriptor(
  name='GenotypeMatrix',
  full_name='ga4gh.schemas.ga4gh.GenotypeMatrix',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='nindividuals', full_name='ga4gh.schemas.ga4gh.GenotypeMatrix.nindividuals', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='nvariants', full_name='ga4gh.schemas.ga4gh.GenotypeMatrix.nvariants', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='genotypes', full_name='ga4gh.schemas.ga4gh.GenotypeMatrix.genotypes', index=2,
...
_SEARCHGENOTYPESREQUEST = _descriptor.Descriptor(
  ...
  full_name='ga4gh.schemas.ga4gh.SearchGenotypesRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='variant_set_id', full_name='ga4gh.schemas.ga4gh.SearchGenotypesRequest.variant_set_id', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='call_set_ids', full_name='ga4gh.schemas.ga4gh.SearchGenotypesRequest.call_set_ids', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reference_name', full_name='ga4gh.schemas.ga4gh.SearchGenotypesRequest.reference_name', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='start', full_name='ga4gh.schemas.ga4gh.SearchGenotypesRequest.start', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='end', full_name='ga4gh.schemas.ga4gh.SearchGenotypesRequest.end', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='page_size', full_name='ga4gh.schemas.ga4gh.SearchGenotypesRequest.page_size', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='page_token', full_name='ga4gh.schemas.ga4gh.SearchGenotypesRequest.page_token', index=6,
...
_SEARCHGENOTYPESRESPONSE = _descriptor.Descriptor(
  ...
  full_name='ga4gh.schemas.ga4gh.SearchGenotypesResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='variants', full_name='ga4gh.schemas.ga4gh.SearchGenotypesResponse.variants', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='call_set_ids', full_name='ga4gh.schemas.ga4gh.SearchGenotypesResponse.call_set_ids', index=1,
      number=2, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='genotypes', full_name='ga4gh.schemas.ga4gh.SearchGenotypesResponse.genotypes', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='next_page_token', full_name='ga4gh.schemas.ga4gh.SearchGenotypesResponse.next_page_token', index=3,
...
GenotypeMatrix = _reflection.GeneratedProtocolMessageType('GenotypeMatrix', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:ga4gh.schemas.ga4gh.GenotypeMatrix)
  ))
...
SearchGenotypesRequest = _reflection.GeneratedProtocolMessageType('SearchGenotypesRequest', (_message.Message,), dict(
  ...
  __module__ = 'ga4gh.schemas.ga4gh.genotype_service_pb2'
  # @@protoc_insertion_point(class_scope:ga4gh.schemas.ga4gh.SearchGenotypesRequest)
  ))
...
SearchGenotypesResponse = _reflection.GeneratedProtocolMessageType('SearchGenotypesResponse', (_message.Message,), dict(
  ...
  __module__ = 'ga4gh.schemas.ga4gh.genotype_service_pb2'
  # @@protoc_insertion_point(class_scope:ga4gh.schemas.ga4gh.SearchGenotypesResponse)
  ))
