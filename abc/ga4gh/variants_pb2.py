...
_VARIANTSETMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='attributes', full_name='ga4gh.VariantSetMetadata.attributes', index=6,
...
_CALLSET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='attributes', full_name='ga4gh.CallSet.attributes', index=6,
      number=8, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CALL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='attributes', full_name='ga4gh.Call.attributes', index=5,
      number=8, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VARIANT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='attributes', full_name='ga4gh.Variant.attributes', index=10,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='variant_type', full_name='ga4gh.Variant.variant_type', index=12,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='svlen', full_name='ga4gh.Variant.svlen', index=13,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cipos', full_name='ga4gh.Variant.cipos', index=14,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ciend', full_name='ga4gh.Variant.ciend', index=15,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='filters_applied', full_name='ga4gh.Variant.filters_applied', index=16,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='filters_passed', full_name='ga4gh.Variant.filters_passed', index=17,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='filters_failed', full_name='ga4gh.Variant.filters_failed', index=18,
...
_VARIANTSETMETADATA.fields_by_name['attributes'].message_type = ga4gh_dot_common__pb2._ATTRIBUTES
_VARIANTSET.fields_by_name['metadata'].message_type = _VARIANTSETMETADATA
_CALLSET.fields_by_name['attributes'].message_type = ga4gh_dot_common__pb2._ATTRIBUTES
_CALL.fields_by_name['genotype'].message_type = google_dot_protobuf_dot_struct__pb2._LISTVALUE
_CALL.fields_by_name['attributes'].message_type = ga4gh_dot_common__pb2._ATTRIBUTES
_VARIANT.fields_by_name['attributes'].message_type = ga4gh_dot_common__pb2._ATTRIBUTES
